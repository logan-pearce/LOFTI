...
################################## User input ##################################
system = 'GKTau'
directory = system+"_ofti_output_2019-02-12/"
...
plot_orbits(a1,T1,to1,e1,i1,w1,O1, output_name, date, axlim = 20)

# X/Z plane:
print 'XZ plane'
output_name = directory + system+"_orbits_xz"
plot_orbits(a1,T1,to1,e1,i1,w1,O1, output_name, date, axlim = 20, plane = 'xz')

# Y/Z plane:
print 'YZ plane'
output_name = directory + system+"_orbits_yz"
plot_orbits(a1,T1,to1,e1,i1,w1,O1, output_name, date, axlim = 20, plane = 'yz')

# 3D
print '3D'
output_name = directory + system+"_orbits_3d"
plot_orbits3d(a1,T1,to1,e1,i1,w1,O1, output_name, date, axlim = 20)
