...
# Set to False if there are no RV measurements for the system:
RV = False
...
d = 2015.5
plxb, plxberr = 7.736181763296462, 0.0434716242332522
plxa, plxaerr = 7.662587421336056, 0.04604393474172906
...
RAb, RAberr = 68.39404779762734, 0.04225973382885226*mas_to_deg
RAa, RAaerr = 68.39194796115807, 0.04693034099138683*mas_to_deg
Decb, Decberr = 24.351538070211536, 0.02838685021460219*mas_to_deg
Deca, Decaerr = 24.354652459003447, 0.030860001768019497*mas_to_deg

# Proper motions (in mas/yr):
pmRAb, pmRAberr = 7.752527330204136, 0.09501610992230507
pmRAa, pmRAaerr = 5.882953921562138, 0.10768919956109295
pmDecb, pmDecberr = -20.48313007512066, 0.06976340757304786
pmDeca, pmDecaerr = -20.550925312475705, 0.07597187724061871
...
# Compute rho and pa for scale and rotate OFTI step:
...
if rank == 0:
    ...
    print 'Distance in pc:',d_star,d_star_err
    ...
    print
    print 'Separation in mas:',rho, rhoerr
    print 'PA in degrees:',pa,paerr
# RV at Gaia obs date:
if RV == True:
    def line(x,m,b):
        return m*x+b
