...
#
# Version 2 uses a linearly descending prior probability distribution function for eccentricity (version 1 uses uniform)
#
...
# Separations in mas:
r_obs =np.array([2209.07702358,2210.41860384,2211.60732247,2211.9748246,2211.63526996,2212.80450342]) 
rerr = np.array([0.99741127,1.3599545,1.19426205,1.19463021,0.67198557,0.79537205])     

# Position angles in deg:
PA_obs = np.array([27.268443,27.17973618,27.04215366,26.97998399,26.92480386,26.92492216])
terr = np.array([0.02289009,0.01931462,0.01793369,0.03864456,0.02181669,0.0255155])

# Obs dates:
d = np.array([2009.4109589,2011.4739726,2014.57534247,2016.45628415,2017.48767123,2018.49589041])

# Stellar mass in solar masses:
m_star, m_star_err = 0.85,0.1
...
if rank==0:
    os.system('mkdir '+name+'_lofti_output_v2_mpi')
directory = name+'_lofti_output_v2_mpi'
comm.barrier()
...
#Eccentricity:
e = np.random.triangular(0,0,1,10000)
...
if rank == 0:
    print 'starting loop.'
print "Rank ",rank," chi_min ",chi_min
